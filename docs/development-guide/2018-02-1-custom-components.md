...
This is especially useful when using [Component groups](/creator/development-guide/querying-components). Since component groups list entities based on components they own, a simple flag component can tell entities apart from others.
