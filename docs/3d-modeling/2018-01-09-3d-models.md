...
See [Set entity position](/development-guide/creator/entity-positioning) for information on how you can configure a 3D model in a Decentraland scene to set its position, scale, etc.

Keep in mind that all models, their shaders and their textures must be within the parameters of the [scene limitations](/development-guide/creator/scene-limitations).
...
- [Materials](/3d-modeling/materials)
- [Meshes](/3d-modeling/meshes)
- [Colliders](/3d-modeling/colliders)
- [Animations](/3d-modeling/animations)
