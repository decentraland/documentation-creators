...
A scene that displays a crypto collectible NFT in a picture frame. See [display a certified NFT](/creator/development-guide/display-a-certified-nft) for more details.
