...
![Make sure the framerate is set to 30 fps before starting.](/images/emotes/framerate.png)
...
![Changing to Pose Mode.](/images/emotes/pode_mode.gif)
...
![These are the bottom windows. The top one is in the ***Graph Editor,*** the middle one in the ***Dope Sheet,*** and the bottom one is the ***Timeline.*** The top red arrow shows the ***Only Show Selected*** tool and the bottom one shows the ***Auto Keying***.](/images/emotes/workspace.png)
...
![Ground and animation area reference.](/images/emotes/ground_reference.png)
...
![Create a new animation by duplicating the existing one or by clicking on ***Unlink Action*** and then ***New***.](/images/emotes/new_anim.gif)
...
![Browsing animations: The ones with an F will be saved, and the ones with 0 will be deleted.](/images/emotes/anim_list.gif)
...
![Make channels visible before keyframing!](/images/emotes/visibility_graph_editor.gif)
...
![Turn off the mesh visibility before exporting!](h/images/emotes/mesh_visibility.gif)

_Turn off the mesh visibility before exporting!_

To export, go to *File* > *Export* > *glTF2.0 (.glb, .gltf)*

![export.gif](/images/emotes/export.gif)
...
![export1.png](/images/emotes/export1.png)

![visible_objects2.gif](/images/emotes/visible_objects2.gif)
...
![export2.png](/images/emotes/export2.png)

![animation_export.gif](/images/emotes/animation_export.gif)
...
![Screen Shot 2022-08-04 at 12.39.58.png](/images/emotes/Screen_Shot_2022-08-04_at_12.39.58.png)

Once it is imported, click on this eye icon to visualize it!

![visulize.png](/images/emotes/visulize.png)
