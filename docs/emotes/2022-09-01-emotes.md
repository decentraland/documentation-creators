...
![Untitled](/images/emotes/Untitled.png)
...
**Rarity:**
The rarity of your Wearable determines the total number of NFTs that may be minted based on your item. The rarities and the maximum number of NFTs that you may mint for each are: Unique (1); Mythic (10); Legendary (100); Epic (1000); Rare (5000); Uncommon (10000); Common (100000).

**Play Mode:**
This will determine whether your Emote will only be played once or if it will be looped, meaning that an avatar will continue doing the action until they move.
...
![Untitled](/images/emotes/Untitled%205.png)
...
![Untitled](/images/emotes/Untitled%206.png)
...
![Untitled](/images/emotes/Untitled%207.png)
...
![Untitled](/images/emotes/Untitled%208.png)
